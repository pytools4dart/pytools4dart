...
#   /home/claudia/DEV/pytools4dartMTD/pytools4dart/xsdschema/inversion.xsd
#
# Command line:
#   /home/claudia/DEV/pytools4dartMTD/venv/bin/generateDS.py -m --always-export-default --export="write literal etree" -p "create" --post-attrib-setter="update_node(self,self.troot,"inversion")" --pre-ctor="self.troot=get_gs_troot("inversion","{classname}")" --post-ctor="update_node(self,self.troot,"inversion")" --imports="from pytools4dart.xsdschema.utils import get_gs_troot, update_node" -o "/home/claudia/tmp/inversion.py" /home/claudia/DEV/pytools4dartMTD/pytools4dart/xsdschema/inversion.xsd
#
