...
#   /home/claudia/DEV/pytools4dartMTD/pytools4dart/xsdschema/maket.xsd
#
# Command line:
#   /home/claudia/DEV/pytools4dartMTD/venv/bin/generateDS.py -m --always-export-default --export="write literal etree" -p "create" --post-attrib-setter="update_node(self,self.troot,"maket")" --pre-ctor="self.troot=get_gs_troot("maket","{classname}")" --post-ctor="update_node(self,self.troot,"maket")" --imports="from pytools4dart.xsdschema.utils import get_gs_troot, update_node" -o "/home/claudia/tmp/maket.py" /home/claudia/DEV/pytools4dartMTD/pytools4dart/xsdschema/maket.xsd
#
