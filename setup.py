...
setup(
    ...
    # Author details
    author='Eric Chraibi, Dav Ebengo, Claudia Lavalley, Yinjie Wang, Jean-Baptiste Féret, Florian de Boissieu',
    author_email='eric.chraibi@irstea.fr',
    ...
    install_requires=['setuptools','geopandas','lxml'],
